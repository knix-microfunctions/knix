...
$RIAK_ADMIN bucket-type create mfn_counter_trigger '{"props":{"postcommit":[{"mod":"mfn_counter_triggers","fun":"counter_trigger"}],"datatype":"counter"}}'
$RIAK_ADMIN bucket-type activate mfn_counter_trigger
$RIAK_ADMIN bucket-type create triggers '{"props":{"postcommit":[{"mod":"workflow_triggers","fun":"workflow_trigger"}]}}'
$RIAK_ADMIN bucket-type activate triggers
$RIAK_ADMIN bucket-type create strong '{"props":{"consistent":true}}'
$RIAK_ADMIN bucket-type activate strong
