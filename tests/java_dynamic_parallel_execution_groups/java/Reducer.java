...
public class Reducer
{
	...
	public Object handle(Object event, MicroFunctionsAPI context)
	{
		...
		{
			List<String> messages = context.getSessionUpdateMessages(numMappersToExpect);
			...
			context.log("processed messages");
			if (mapperResultsJSONObject.keySet().size() == numMappersToExpect || 
					mapperResultsJSONArray.keySet().size() == numMappersToExpect)
			{
