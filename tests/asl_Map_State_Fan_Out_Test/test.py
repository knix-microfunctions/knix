...
class MapStateTest(unittest.TestCase):
    ...
    def test_map_state(self):
            ...
            event = {"chunks": [0,1,2,3,4,5] 
            }                     

            expectedResponse = [0, 1, 2, 3, 4, 5] 

            testtuplelist.append((json.dumps(event), json.dumps(expectedResponse)))
        
            test = MFNTest(test_name="Map State Fan Out Test", workflow_filename="workflow_map_state_fan_out_test.json" ) 
